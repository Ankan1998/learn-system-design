...
# docs/ and site/ are generated by scripts/build_docs.py + mkdocs; skip them
# so the counts reflect the authored source only.
SKIP = {"docs", "site", ".venv", "venv", ".git", "node_modules", "__pycache__"}
